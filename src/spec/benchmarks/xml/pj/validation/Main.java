 ...
 */
package spec.benchmarks.xml.pj.validation;
...
import spec.benchmarks.xml.pj.XMLBenchmark;
...
,
    ...
    public void harnessMain() {
        try {
            ...
            System.out.println("Sequential xml validation has taken  " + (time / 1000.0) + " seconds.");
        } catch (Exception e) {
            e.printStackTrace(Context.getOut());
        }
    }
